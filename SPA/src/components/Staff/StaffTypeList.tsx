...
export const StaffTypeList: React.FC = () => {
  ...
  confirmAlert({
    title: "तुम्हाला हा स्टाफ प्रकार हटवायचा आहे का?",
    ...
    buttons: [
      {
        ...
        onClick: async () => {
          try {
            ...
            setAlertMessage("स्टाफ प्रकार यशस्वीरित्या हटवला!");
          } catch (error) {
            setAlertType("error");
            setAlertMessage("स्टाफ प्रकार हटवण्यात अडचण आली: " + (error as any).message);
          }
        }
      },
      {

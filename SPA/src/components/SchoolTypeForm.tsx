...
//   const [formData, setFormData] = useState<SchoolTypeRequest>({
//     type: "",
//   });
...
//     error: fetchError,
//   } = useGetSchoolTypeByIdQuery(id!, { skip: !isEditMode });

//   const [createSchoolType, { isLoading: isCreating }] =
//     useAddSchoolTypeMutation();
//   const [updateSchoolType, { isLoading: isUpdating }] =
//     useUpdateSchoolTypeMutation();
...
//     try {
//      if (isEditMode) {
//   await updateSchoolType({ id: id!, data: formData }).unwrap();
//   toast.success("School type updated successfully");
// } else {
//   await createSchoolType(formData).unwrap();
...
//             {(fetchError as any)?.data?.message || "Failed to load school type"}
//           </div>
//           <button
//             onClick={() => navigate("/admin/schooltype-list")}
//             className="px-4 py-2 bg-[#5C4033] text-white rounded hover:bg-[#4a3328]"
//           >
//             Back to List
//           </button>
//         </div>
...
//             {isEditMode ? "Edit School Type" : "Create New School Type"}
//           </h2>
...
//                   text-sm font-medium text-white bg-[#5C4033] hover:bg-[#4a3328] 

  ...
  return (
    <PageLayout>
      ...
      <div className="h-screen w-full flex items-center justify-center bg-gray-50 px-4 py-6">
        <div
          className="w-full max-w-6xl bg-white rounded-lg shadow-lg p-8 border border-gray-200 overflow-auto
          h-[80vh]"
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              >
                <option className="text-sm font-semibold" value="Aided">
                  सहाय्यित
                </option>
                <option className="text-sm font-semibold" value="Non-Aided">
                  असहाय्यित
                </option>
              </select>
            </div>

...
interface AidedAshramSchool {
  ...
  contact_2: string;
  femaleSuperintendentName: string;
  contact_3: string;
  email: string;
}

const AnudanitList: React.FC<{
  data: AidedAshramSchool[];
  ...
  if (selectedId && selected) {
    return (
      <div>
        ...
        <p className="text-gray-700 mb-1">
          <strong>संपर्क क्रमांक :</strong> {selected.contact_1}
        </p>
        <p className="text-gray-700 mb-1">
          <strong>अध्यक्ष :</strong> {selected.superintendentName}
        </p>
        <p className="text-gray-700 mb-1">
          <strong>संपर्क क्रमांक :</strong> {selected.contact_2}
        </p>
        <p className="text-gray-700 mb-1">
          <strong>स्त्री अधिक्षिका नाव :</strong>{" "}
          {selected.femaleSuperintendentName}
        </p>
        <p className="text-gray-700 mb-1">
          <strong>संपर्क क्रमांक:</strong> {selected.contact_3}
        </p>

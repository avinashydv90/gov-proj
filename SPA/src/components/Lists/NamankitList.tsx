...
interface ReputedSchool {
  ...
  email: string | null; // assuming email could be empty or not provided
}

const NamankitList: React.FC<{
  data: ReputedSchool[];
  ...
  if (selectedId && selected) {
    return (
      <div>
        ...
        <p className="text-gray-700 mb-1">
          <strong>संपर्क क्रमांक :</strong> {selected.contactNumber}
        </p>

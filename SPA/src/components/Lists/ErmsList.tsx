  ...
  if (selectedId && selected) {
    return (
      <div>
        ...
        <p className="text-gray-700 mb-1">
          <strong>मुख्याध्यापक नाव :</strong> {selected.PrincipleName}
        </p>
        <p className="text-gray-700 mb-1">
          <strong>संपर्क क्रमांक :</strong> {selected.PrincipleContact}
        </p>
        <p className="text-gray-700">
          <strong>अधिक्षक नाव :</strong> {selected.president}
        </p>
        <p className="text-gray-700 mb-1">
        ...
        <p className="text-gray-700 mb-1">
          <strong>शाळेचा ई-मेल आय डी :</strong> {selected.EmailId}
        </p>
